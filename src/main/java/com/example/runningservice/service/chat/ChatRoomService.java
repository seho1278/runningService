...
public class ChatRoomService {
    ...
    public Map<ChatRoomEntity, ChatRoomDetailsDto> getCrewChatRoomListForMember(Long crewId, Long memberId) {
        ...
        Map<ChatRoomEntity, ChatRoomDetailsDto> chatRoomDetailsMap = new HashMap<>();
        ...
        for (ChatJoinEntity chatJoinEntity : chatJoinList) {
            ...
            int messageCount = messageRepository.countMessagesAfterReadAt(chatJoinEntity, chatJoinEntity.getReadAt());
            int memberCount = chatJoinRepository.countByChatRoom(chatRoomEntity);

            ChatRoomDetailsDto details = ChatRoomDetailsDto.builder()
                .messageCount(messageCount)
                .memberCount(memberCount)
                .memberEntityList(memberList)
                .build();

            chatRoomDetailsMap.put(chatRoomEntity, details);
        }

        return chatRoomDetailsMap;
    }
