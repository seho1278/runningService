...
public class CrewCreateRequestDto {
    ...
    @ConstructorProperties({"description", "crewCapacity", "activityRegion", "crewImage",
        "runRecordOpen", "leaderRequired", "minYear", "maxYear", "gender", "crewName"})
    public CrewCreateRequestDto(String description, Integer crewCapacity, Region activityRegion,
        MultipartFile crewImage, Boolean runRecordOpen, Boolean leaderRequired,
        Integer minYear, Integer maxYear, Gender gender, String crewName) {
